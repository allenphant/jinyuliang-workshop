...
- 圖表須保留分母、事件數、設限數或網絡邊的判定依據；視覺規格沿用米白、墨綠、朱砂紅與金色。`,h={trigger:`# A0.4｜讀取初始通報，將手冊門檻轉成可稽核欄位
import pandas as pd
