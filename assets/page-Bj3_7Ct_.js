...
- 圖表須保留分母、事件數、設限數或網絡邊的判定依據；視覺規格沿用米白、墨綠、朱砂紅與金色。`,g={trigger:`# A0.4｜讀取初始通報，將手冊門檻轉成可稽核欄位
import pandas as pd
...
fig.show(config=svg_config("food_coexposure_heatmap"))`,crude:`# A4.4｜建立可重用的 2×2 表函數
import pandas as pd
import scipy.stats
...
# 範例：result = two_by_two(analysis, "jade_dew_custard")`,adjusted:`# A6.4｜先做場地分層與 MH OR，再建立多變項 logistic regression
import numpy as np
import pandas as pd
import statsmodels.formula.api as smf
